...
game.TitleScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        this.dialog = new(me.Renderable.extend({
            init: function() {
                this._super(me.Renderable, "init", [0, 0, me.game.viewport.width / 2, me.game.viewport.height / 2]), this.font = new me.Font("gamefont", 40, "black", "left"), this.steps = "score: " + game.data.steps.toString(), this.topSteps = "High Score: " + me.save.topSteps.toString()
            },
            draw: function(a) {
