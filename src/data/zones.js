export const ZONES = [
  {
    ...
    clubs: [
      ...
      { name: 'Atria Institute of Technology', presidentPhoto: '/assets/team/2026-27/pres/Rithvik Ravindranath.jpg', presidentName: 'Rtr. Rithvik Ravindranath', clubWebsite: 'https://www.instagram.com/rotaract_atria?utm_source=qr' },
      { name: 'Bangalore Advaitha', presidentPhoto: '/assets/team/2026-27/pres/Amal.jpg', presidentName: 'IPP. Rtr. Amal', clubWebsite: '' },
      { name: 'Bangalore Southwest', presidentPhoto: '/assets/team/2026-27/pres/Thanisha.jpg', presidentName: 'Rtr. Thanisha Kushalappa', clubWebsite: '' },
      { name: 'Bengaluru Harmony', presidentPhoto: '', presidentName: '', clubWebsite: '' },
      { name: 'Bengaluru HSR', presidentPhoto: '/assets/team/2026-27/pres/Dwani.jpeg', presidentName: 'Rtr. Dwani S. V.', clubWebsite: '' },
      { name: 'Bengaluru South End', presidentPhoto: '/assets/team/2026-27/pres/Shraddha.jpg', presidentName: 'Rtr. Shraddha T. R.', clubWebsite: '' },
      { name: 'DA Pandu RV Dental College', presidentPhoto: '/assets/team/2026-27/pres/Diyanath.jpg', presidentName: 'Rtr. Diyanath Inaganti', clubWebsite: '' },
      { name: 'Govt. Engg. College Ramanagara', presidentPhoto: '/assets/team/2026-27/pres/Shemasta.jpg', presidentName: 'Rtr. Shemasta Haseen Khan', clubWebsite: '' },
      { name: 'KLE Law College', presidentPhoto: '/assets/team/2026-27/pres/Paulomi.jpg', presidentName: 'Rtr. Paulomi Santra', clubWebsite: '' },
      { name: 'Koramangala', presidentPhoto: '/assets/team/2026-27/pres/Gagana.jpg', presidentName: 'Rtn. Rtr. Gagana M.', clubWebsite: '' },
      ...
      { name: 'Shantiniketan', presidentPhoto: '/assets/team/2026-27/pres/Rihan.jpeg', presidentName: 'Rtr. Rihan Pasha', clubWebsite: '' },
  ...
  },
  {
    ...
    clubs: [
      { name: 'Bangalore Aagneya', presidentPhoto: '/assets/team/2026-27/pres/SaiPavan.jpg', presidentName: 'Rtr. Sai Pavan A.', clubWebsite: '' },
      { name: 'Bangalore Institute of Technology', presidentPhoto: '/assets/team/2026-27/pres/Shreya.jpg', presidentName: 'Rtr. Shreya Srinivas', clubWebsite: '' },
      { name: 'Bangalore Prime', presidentPhoto: '/assets/team/2026-27/pres/Anshuman.jpg', presidentName: 'Rtr. Anshuman Agarwal', clubWebsite: '' },
      { name: 'Bangalore Revolution', presidentPhoto: '/assets/team/2026-27/pres/Srusti.JPG', presidentName: 'Rtr. Srusti Y. L.', clubWebsite: '' },
      { name: 'Bangalore Vijayanagar', presidentPhoto: '/assets/team/2026-27/pres/Dharshan.jpeg', presidentName: 'Rtr. Dharshan .Y', clubWebsite: '' },
      ...
      { name: 'Samarpane RC College', presidentPhoto: '/assets/team/2026-27/pres/Darshan.png', presidentName: 'Rtr. Darshan M.', clubWebsite: '' },
      { name: 'Sri Saraswathi Vidyanikethana', presidentPhoto: '/assets/team/2026-27/pres/Thilak.png', presidentName: 'Rtr. Thilak T. K.', clubWebsite: '' },
  ...
  },
  {
    ...
    clubs: [
      { name: 'Banashankari', presidentPhoto: '/assets/team/2026-27/pres/Abhay.jpg', presidentName: 'Rtr. Abhay Sirigeri', clubWebsite: '' },
      { name: 'Bangalore East', presidentPhoto: '/assets/team/2026-27/pres/Aakash.jpeg', presidentName: 'Rtr. Aakash Kashyap R.', clubWebsite: '' },
      ...
      { name: 'Indian Institute of Fashion Technology', presidentPhoto: '/assets/team/2026-27/pres/Ramya.jpeg', presidentName: 'Rtr. Ramya Prasad', clubWebsite: '' },
  ...
  },
  {
    ...
    clubs: [
      ...
      { name: 'Jyoti Nivas College', presidentPhoto: '/assets/team/2026-27/pres/SanjanaNair.jpg', presidentName: 'Rtr. Sanjana Nair', clubWebsite: '' },
      { name: 'Krupanidhi College of Commerce & Management', presidentPhoto: '', presidentName: '', clubWebsite: '' },
      { name: 'KSSEM', presidentPhoto: '', presidentName: 'Rtr. Lohith J.', clubWebsite: '' },
